...
return [
    ...
    'autoload_internal_extension_signatures' => [
        'apcu'        => '.phan/internal_stubs/apcu.phan_php',
        'ast'         => '.phan/internal_stubs/ast.phan_php',
        'calendar'    => '.phan/internal_stubs/calendar.phan_php',
        'ctype'       => '.phan/internal_stubs/ctype.phan_php',
        'curl'        => '.phan/internal_stubs/curl.phan_php',
        'exif'        => '.phan/internal_stubs/exif.phan_php',
        'ffi'         => '.phan/internal_stubs/ffi.phan_php',
        'ftp'         => '.phan/internal_stubs/ftp.phan_php',
        'gd'          => '.phan/internal_stubs/gd.phan_php',
        'gettext'     => '.phan/internal_stubs/gettext.phan_php',
        'gmp'         => '.phan/internal_stubs/gmp.phan_php',
        'igbinary'    => '.phan/internal_stubs/igbinary.phan_php',
        'imagick'     => '.phan/internal_stubs/imagick.phan_php',
        'imap'        => '.phan/internal_stubs/imap.phan_php',
        'ldap'        => '.phan/internal_stubs/ldap.phan_php',
        'mbstring'    => '.phan/internal_stubs/mbstring.phan_php',
        'memcached'   => '.phan/internal_stubs/memcached.phan_php',
        'mongodb'     => '.phan/internal_stubs/mongodb.phan_php',
        'mysqli'      => '.phan/internal_stubs/mysqli.stub.php',
        'mysqlnd'     => '.phan/internal_stubs/mysqlnd.phan_php',
        'openssl'     => '.phan/internal_stubs/openssl.phan_php',
        'pcntl'       => '.phan/internal_stubs/pcntl.phan_php',
        'pdo'         => '.phan/internal_stubs/pdo.phan_php',
        'pdo_mysql'   => '.phan/internal_stubs/pdo_mysql.phan_php',
        'pdo_sqlite'  => '.phan/internal_stubs/pdo_sqlite.phan_php',
        ...
        'yaml'        => '.phan/internal_stubs/yaml.phan_php',
        'zlib'        => '.phan/internal_stubs/zlib.phan_php',
    ],
