...
class SimplifyExpressionVisitor extends PluginAwarePostAnalysisVisitor
{
     ...
     */
    private static function getBoolConst(Node|float|int|null|string $node): ?bool
    {
    ...
    private function suggestBoolSimplification(Node $node, Node|float|int|string $inner_expr, bool $negate): void
    {
