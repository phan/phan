...
%s:13 ParamError call with 0 arg(s) to t1() that requires 1 arg(s) defined at %s:3
%s:14 ParamError call with 3 arg(s) to t1() that only takes 2 arg(s) defined at %s:3
