...
final class TypeTest extends CodeBaseAwareTestBase
{
    ...
    public static function isSubtypeOfProvider(): array
    {
        return [
            ...
            [true, 'callable-string', 'non-empty-string'],
            ...
            [true, 'callable-array', 'non-empty-array'],
            [true, 'callable-array', 'non-empty-array<mixed>'],
            [false, 'callable-array', 'non-empty-array<string>', true],
            [false, 'callable-array', 'non-empty-list', true],
            [false, 'callable-array', 'non-empty-associative-array', true],
