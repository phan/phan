...
final class HTMLPrinterTest extends BaseTest
{
    ...
    public function testPrintOutput() : void
    {
        ...
        $expected_output = '';
        $expected_output .= '<p><span class="phan_file">dim.php</span>:<span class="phan_line">10</span>: Variable <span class="phan_variable">varName</span> was undeclared, but array fields are being added to it.</p>' . \PHP_EOL;
        $expected_output .= '<p><span class="phan_file">test.php</span>:<span class="phan_line">1</span>: <span class="phan_unknown">fake error</span></p>' . \PHP_EOL;
        $expected_output .= '<p><span class="phan_file">undefinedmethod.php</span>:<span class="phan_line">1</span>: Call to undeclared method <span class="phan_method">\Foo::bar</span></p>' . \PHP_EOL;
