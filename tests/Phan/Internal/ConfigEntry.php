...
class ConfigEntry
{
    ...
    const CATEGORIES = [
        ...
        'ast_trim_max_elements_per_level' => self::CATEGORY_ANALYSIS,
        'ast_trim_max_total_elements' => self::CATEGORY_ANALYSIS,
        'max_union_type_set_size' => self::CATEGORY_ANALYSIS,
        ...
        'strict_array_checking' => self::CATEGORY_TYPE_CASTING,
        ...
        'autoload_internal_extension_signatures_template_classes' => self::CATEGORY_ANALYSIS,
        'autoload_internal_extension_signatures_template_functions' => self::CATEGORY_ANALYSIS,
