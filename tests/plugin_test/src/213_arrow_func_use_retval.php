...
$modify2 = static fn &(int &$v) => $v *= 2;  // this is not a valid reference.
$arg = 1;
var_export($modify2($arg));
var_export($modify2($arg));
$modify3 = static fn &(int &$v) => 2;  // this is not a valid reference.
