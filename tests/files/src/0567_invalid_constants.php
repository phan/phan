...
exampleConstantDefs();
// Note that the warning about cons2128 is a PhanTypeMismatchArgumentInternalReal because the real type of a define()d constant is known (widened to the non-literal type).
