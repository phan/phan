...
function check_literal_conditional() {
    ...
    intdiv(FEATURE_FLAG2 ? 'value' : $x, 2);  // Same uncertainty in the general case. Also, PhanRedundantCondition isn't emitted because the real type of a define()d constant is widened to bool (define() is used for configuration).
