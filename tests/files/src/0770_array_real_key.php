...
call_user_func(function () {
    ...
    foreach ($values as $i => $value) {
        // Note: This is PhanTypeMismatchArgumentInternal (not ProbablyReal)
        // because assume_real_types_for_internal_functions is false for the tests in tests/files/src
        echo strlen($i);
        echo strlen($value);
    }
