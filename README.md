...
This version (branch) of Phan depends on PHP 7.0-7.3 with the [php-ast](https://github.com/nikic/php-ast) extension (0.1.5+ or 1.0.0+) and supports PHP version 7.0-7.3 syntax.
