...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0492_class_constant_visibility.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0492_class_constant_visibility.php#L34).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/php70_files/expected/003_short_array.php.expected#L7) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/php70_files/src/003_short_array.php#L21).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/015_trait_method.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/015_trait_method.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0278_should_differentiate_phpdoc_return_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0278_should_differentiate_phpdoc_return_type.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0639_duplicate_const_prop.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0639_duplicate_const_prop.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/024_strict_property_assignment.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/024_strict_property_assignment.php#L20).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0574_array_op.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0574_array_op.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0287_suspicious_nullable_array.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0287_suspicious_nullable_array.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0442_unset_suspicious.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0442_unset_suspicious.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0305_is_a_tests.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0305_is_a_tests.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0570_switch_on_class.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0570_switch_on_class.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0532_empty_array_element.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0532_empty_array_element.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0590_crash_test.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0590_crash_test.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0541_unset.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0541_unset.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0379_bad_prop_access.php.expected#L7) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0379_bad_prop_access.php#L28).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0379_bad_prop_access.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0379_bad_prop_access.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0561_bitwise_operands.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0561_bitwise_operands.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/051_invalid_function_node.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/051_invalid_function_node.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/089_invalid_callable_key.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/089_invalid_callable_key.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/062_strict_function_checking.php.expected#L10) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/062_strict_function_checking.php#L42).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0540_invalid_method_name.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0540_invalid_method_name.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0521_misuse_closure_type.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0521_misuse_closure_type.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0549_invalid_clone.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0549_invalid_clone.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0537_closure_scope.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0537_closure_scope.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0439_multi.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0439_multi.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0402_array_destructuring.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0402_array_destructuring.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0546_require_other_testing.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0546_require_other_testing.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/rasmus_files/expected/0021_foreach.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/rasmus_files/src/0021_foreach.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0346_dynamic_instanceof.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0346_dynamic_instanceof.php#L24).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0114_array_concatenation.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0114_array_concatenation.php#L12).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0580_numeric_string.php.expected#L14) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0580_numeric_string.php#L23).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0628_arithmetic_op_more_warn.php.expected#L13) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0628_arithmetic_op_more_warn.php#L27).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0148_invalid_array.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0148_invalid_array.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0540_invalid_method_name.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0540_invalid_method_name.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/expected/006_typed_properties_invalid_default.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/src/006_typed_properties_invalid_default.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0636_invalid_property_name_type.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0636_invalid_property_name_type.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0545_require_testing.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0545_require_testing.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/004_partial_arithmetic.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/004_partial_arithmetic.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0012_closures.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0012_closures.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0628_arithmetic_op_more_warn.php.expected#L9) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0628_arithmetic_op_more_warn.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0574_array_op.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0574_array_op.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0540_invalid_method_name.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0540_invalid_method_name.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0636_invalid_property_name_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0636_invalid_property_name_type.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0454_throws.php.expected#L10) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0454_throws.php#L57).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0454_throws.php.expected#L11) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0454_throws.php#L60).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0454_throws.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0454_throws.php#L33).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0454_throws.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0454_throws.php#L30).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0560_trait_in_param_return.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0560_trait_in_param_return.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0560_trait_in_param_return.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0560_trait_in_param_return.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0507_unary_op_warn.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0507_unary_op_warn.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0645_increment_branch.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0645_increment_branch.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0507_unary_op_warn.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0507_unary_op_warn.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0475_analyze_yield_from.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0475_analyze_yield_from.php#L31).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0402_array_destructuring.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0402_array_destructuring.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0561_bitwise_operands.php.expected#L8) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0561_bitwise_operands.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0486_crash_test.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0486_crash_test.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0253_return_type_match.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0253_return_type_match.php#L46).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0602_array_key_from_template.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0602_array_key_from_template.php#L14).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0354_string_index.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0354_string_index.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0465_append_changes_shape.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0465_append_changes_shape.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0429_nullable_offsets.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0429_nullable_offsets.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0475_analyze_yield_from.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0475_analyze_yield_from.php#L24).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0475_analyze_yield_from.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0475_analyze_yield_from.php#L23).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/expected/009_unpack_warnings.php.expected#L13) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/src/009_unpack_warnings.php#L20).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/expected/009_unpack_warnings.php.expected#L9) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/src/009_unpack_warnings.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/expected/009_unpack_warnings.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/php74_files/src/009_unpack_warnings.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0542_foreach_non_traversable.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0542_foreach_non_traversable.php#L41).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0246_iterable.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0246_iterable.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0541_unset.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0541_unset.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0283_parent_constructor_called.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0283_parent_constructor_called.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0028_if_condition_assignment.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0028_if_condition_assignment.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0298_weird_variable_name.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0298_weird_variable_name.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0542_foreach_non_traversable.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0542_foreach_non_traversable.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0581_concat_non_string.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0581_concat_non_string.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0297_ambiguous_trait_source.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0297_ambiguous_trait_source.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0493_inherit_redefined.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0493_inherit_redefined.php#L12).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0188_prop_array_access.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0188_prop_array_access.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/063_invalid_fqsen.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/063_invalid_fqsen.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/053_empty_fqsen.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/053_empty_fqsen.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/063_invalid_fqsen.php.expected#L14) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/063_invalid_fqsen.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/027_invalid_new.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/027_invalid_new.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0545_require_testing.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0545_require_testing.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0545_require_testing.php.expected#L11) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0545_require_testing.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/013_traits12.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/013_traits12.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0504_prop_assignment_fetch.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0504_prop_assignment_fetch.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0278_class_alias.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0278_class_alias.php#L34).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0049_undefined_constant.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0049_undefined_constant.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/094_shutdown_function.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/094_shutdown_function.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0080_undefined_class.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0080_undefined_class.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/065_class_string_create.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/065_class_string_create.php#L13).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0534_missing_static_property.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0534_missing_static_property.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/068_template_typeof.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/068_template_typeof.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/071_other_callable_methods.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/071_other_callable_methods.php#L26).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0594_magic_constant.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0594_magic_constant.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0020_changing_types.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0020_changing_types.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0521_misuse_closure_type.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0521_misuse_closure_type.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/094_shutdown_function.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/094_shutdown_function.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0140_class_context.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0140_class_context.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0048_parent_class_exists.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0048_parent_class_exists.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0226_internal_tostring_parameter_undeclared.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0226_internal_tostring_parameter_undeclared.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0490_throws_suppress.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0490_throws_suppress.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/rewriting_test/expected/004_crash_rewrite_if.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/rewriting_test/src/004_crash_rewrite_if.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0300_misc_types.php.expected#L9) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0300_misc_types.php#L21).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0135_array_assignment_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0135_array_assignment_type.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0203_generic_errors.php.expected#L8) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0203_generic_errors.php#L27).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0203_generic_errors.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0203_generic_errors.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0597_template_support.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0597_template_support.php#L66).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0577_unknown_tags.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0577_unknown_tags.php#L20).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0203_generic_errors.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0203_generic_errors.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0203_generic_errors.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0203_generic_errors.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0618_internal_in_root_ns.php#L38).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0278_internal_elements.php.expected#L24) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0278_internal_elements.php#L108).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0278_internal_elements.php.expected#L16) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0278_internal_elements.php#L94).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0618_internal_in_root_ns.php#L39).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0618_internal_in_root_ns.php#L37).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0524_closure_ambiguous.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0524_closure_ambiguous.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0281_magic_method_support.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0281_magic_method_support.php#L19).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0612_comment_duplicated_property.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0612_comment_duplicated_property.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0611_comment_duplicated_param.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0611_comment_duplicated_param.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0332_override_complex.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0332_override_complex.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0355_namespace_relative.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0355_namespace_relative.php#L34).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0432_phan_comment.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0432_phan_comment.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0301_comment_checks.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0301_comment_checks.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/040_if_assign.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/040_if_assign.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/043_throws.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/043_throws.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/085_throw_type_mismatch.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/085_throw_type_mismatch.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/expected/085_throw_type_mismatch.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/plugin_test/src/085_throw_type_mismatch.php#L17).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0634_empty_var_on_function.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0634_empty_var_on_function.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0284_non_empty_array_default.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0284_non_empty_array_default.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0627_signature_mismatch.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0627_signature_mismatch.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0670_unparseable_property.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0670_unparseable_property.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0601_continue_scope_warning.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0601_continue_scope_warning.php#L24).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/files/expected/0601_continue_scope_warning.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/files/src/0601_continue_scope_warning.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/015_class_const_declaration9.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/015_class_const_declaration9.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/026_invalid_assign.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/026_invalid_assign.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/expected/056_trait_use.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.0.0/tests/misc/fallback_test/src/056_trait_use.php#L11).
