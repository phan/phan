...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0625_static_to_non_static.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0625_static_to_non_static.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/php70_files/expected/004_void.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/php70_files/src/004_void.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/php72_files/expected/0007_deprecated_class_constant.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/php72_files/src/0007_deprecated_class_constant.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0270_deprecated_trait.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0270_deprecated_trait.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/122_closure_reference.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/122_closure_reference.php#L21).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0553_unreferenced_use.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0553_unreferenced_use.php#L28).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0227_trait_class_interface.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0227_trait_class_interface.php#L13).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0627_signature_mismatch.php.expected#L16) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0627_signature_mismatch.php#L27).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0511_implode.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0511_implode.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0857_redefined_class_self.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0857_redefined_class_self.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0721_false_positive_coalesce.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0721_false_positive_coalesce.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0708_loop_issue_examples.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0708_loop_issue_examples.php#L17).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0211_assertion_cast.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0211_assertion_cast.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0708_loop_issue_examples.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0708_loop_issue_examples.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0807_int_cast.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0807_int_cast.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0865_array_key_int_or_string.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0865_array_key_int_or_string.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0803_noop_new.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0803_noop_new.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/expected/0007_self_call.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/src/0007_self_call.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0806_mixin.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0806_mixin.php#L39).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0258_variadic_comment_parsing.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0258_variadic_comment_parsing.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0258_variadic_comment_parsing.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0258_variadic_comment_parsing.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/088_possibly_invalid_argument.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/088_possibly_invalid_argument.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/025_strict_param_checks.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/025_strict_param_checks.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/088_possibly_invalid_argument.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/088_possibly_invalid_argument.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/078_merge_bool_and.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/078_merge_bool_and.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0802_min_max_explode_edge_case.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0802_min_max_explode_edge_case.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/060_strict_method_check.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/060_strict_method_check.php#L12).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/088_possibly_invalid_argument.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/088_possibly_invalid_argument.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/025_strict_param_checks.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/025_strict_param_checks.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0173_primitive_condition.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0173_primitive_condition.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0733_noop_in_for_loop.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0733_noop_in_for_loop.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0698_loop_false_positive.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0698_loop_false_positive.php#L13).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0545_require_testing.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0545_require_testing.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0724_suspicious_comparison_in_loop.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0724_suspicious_comparison_in_loop.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0644_unset_false_positive.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0644_unset_false_positive.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0526_crash.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0526_crash.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0767_literal_count.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0767_literal_count.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0731_weak_equality.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0731_weak_equality.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0574_array_op.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0574_array_op.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0305_is_a_tests.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0305_is_a_tests.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0570_switch_on_class.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0570_switch_on_class.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0532_empty_array_element.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0532_empty_array_element.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/101_extended_return_inferences.php.expected#L12) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/101_extended_return_inferences.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0678_invalid_operations.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0678_invalid_operations.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0590_crash_test.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0590_crash_test.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0541_unset.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0541_unset.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0379_bad_prop_access.php.expected#L7) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0379_bad_prop_access.php#L28).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0379_bad_prop_access.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0379_bad_prop_access.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0679_static_from_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0679_static_from_type.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0624_instantiate_abstract.php.expected#L11) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0624_instantiate_abstract.php#L42).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0624_instantiate_abstract.php.expected#L12) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0624_instantiate_abstract.php#L43).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/138_suspicious_object_comparison.php.expected#L10) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/138_suspicious_object_comparison.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0232_assignment_to_call.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0232_assignment_to_call.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/051_invalid_function_node.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/051_invalid_function_node.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/089_invalid_callable_key.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/089_invalid_callable_key.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/062_strict_function_checking.php.expected#L10) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/062_strict_function_checking.php#L42).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0540_invalid_method_name.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0540_invalid_method_name.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0521_misuse_closure_type.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0521_misuse_closure_type.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0549_invalid_clone.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0549_invalid_clone.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0537_closure_scope.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0537_closure_scope.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0546_require_other_testing.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0546_require_other_testing.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0346_dynamic_instanceof.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0346_dynamic_instanceof.php#L24).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0114_array_concatenation.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0114_array_concatenation.php#L12).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0580_numeric_string.php.expected#L14) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0580_numeric_string.php#L23).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0628_arithmetic_op_more_warn.php.expected#L13) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0628_arithmetic_op_more_warn.php#L27).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0148_invalid_array.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0148_invalid_array.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0636_invalid_property_name_type.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0636_invalid_property_name_type.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0545_require_testing.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0545_require_testing.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/004_partial_arithmetic.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/004_partial_arithmetic.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0012_closures.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0012_closures.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0628_arithmetic_op_more_warn.php.expected#L9) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0628_arithmetic_op_more_warn.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0574_array_op.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0574_array_op.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0540_invalid_method_name.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0540_invalid_method_name.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0454_throws.php.expected#L10) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0454_throws.php#L57).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0454_throws.php.expected#L11) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0454_throws.php#L60).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0454_throws.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0454_throws.php#L33).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0454_throws.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0454_throws.php#L30).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0560_trait_in_param_return.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0560_trait_in_param_return.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0560_trait_in_param_return.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0560_trait_in_param_return.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0507_unary_op_warn.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0507_unary_op_warn.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0645_increment_branch.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0645_increment_branch.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0507_unary_op_warn.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0507_unary_op_warn.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/021_binary_op.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/021_binary_op.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0086_conditional_instanceof_type.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0086_conditional_instanceof_type.php#L14).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0152_closure_casts_callable.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0152_closure_casts_callable.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0748_property_incompatible_reference.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0748_property_incompatible_reference.php#L31).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0752_local_property_reference.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0752_local_property_reference.php#L13).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/expected/0035_class_const.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/src/0035_class_const.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0402_array_destructuring.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0402_array_destructuring.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0561_bitwise_operands.php.expected#L8) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0561_bitwise_operands.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0863_vaguer_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0863_vaguer_type.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0005_compat.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0005_compat.php#L21).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0486_crash_test.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0486_crash_test.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0253_return_type_match.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0253_return_type_match.php#L46).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/expected/0030_def_arg_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/rasmus_files/src/0030_def_arg_type.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0602_array_key_from_template.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0602_array_key_from_template.php#L14).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0354_string_index.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0354_string_index.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0399_array_key.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0399_array_key.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0429_nullable_offsets.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0429_nullable_offsets.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0809_shuffle_converts_to_list.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0809_shuffle_converts_to_list.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/expected/021_associative_array_casting_rules.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/src/021_associative_array_casting_rules.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/expected/019_unpack_allowed_in_const_expr.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/src/019_unpack_allowed_in_const_expr.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0242_void_71.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0242_void_71.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0542_foreach_non_traversable.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0542_foreach_non_traversable.php#L41).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0246_iterable.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0246_iterable.php#L9).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/expected/017_arrow_func_use_retval.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/php74_files/src/017_arrow_func_use_retval.php#L13).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0541_unset.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0541_unset.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0283_parent_constructor_called.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0283_parent_constructor_called.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/062_strict_function_checking.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/062_strict_function_checking.php#L33).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/144_bad_clone.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/144_bad_clone.php#L14).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0298_weird_variable_name.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0298_weird_variable_name.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0542_foreach_non_traversable.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0542_foreach_non_traversable.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0581_concat_non_string.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0581_concat_non_string.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0297_ambiguous_trait_source.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0297_ambiguous_trait_source.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0493_inherit_redefined.php.expected#L7) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0493_inherit_redefined.php#L12).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0188_prop_array_access.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0188_prop_array_access.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/063_invalid_fqsen.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/063_invalid_fqsen.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/053_empty_fqsen.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/053_empty_fqsen.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/063_invalid_fqsen.php.expected#L14) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/063_invalid_fqsen.php#L15).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/027_invalid_new.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/027_invalid_new.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0545_require_testing.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0545_require_testing.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0545_require_testing.php.expected#L11) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0545_require_testing.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0158_conditional_assignment.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0158_conditional_assignment.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0742_dynamic_property_tracking.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0742_dynamic_property_tracking.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/013_traits12.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/013_traits12.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0504_prop_assignment_fetch.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0504_prop_assignment_fetch.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0278_class_alias.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0278_class_alias.php#L34).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0049_undefined_constant.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0049_undefined_constant.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/094_shutdown_function.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/094_shutdown_function.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0080_undefined_class.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0080_undefined_class.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0145_class_implicit_constant.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0145_class_implicit_constant.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0534_missing_static_property.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0534_missing_static_property.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/068_template_typeof.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/068_template_typeof.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/015_class_const_declaration9.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/015_class_const_declaration9.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/094_shutdown_function.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/094_shutdown_function.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/rewriting_test/expected/004_crash_rewrite_if.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/rewriting_test/src/004_crash_rewrite_if.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0806_mixin.php.expected#L12) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0806_mixin.php#L54).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0594_magic_constant.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0594_magic_constant.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0819_stdclass_descendant_class.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0819_stdclass_descendant_class.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0521_misuse_closure_type.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0521_misuse_closure_type.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/094_shutdown_function.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/094_shutdown_function.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0140_class_context.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0140_class_context.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0048_parent_class_exists.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0048_parent_class_exists.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0226_internal_tostring_parameter_undeclared.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0226_internal_tostring_parameter_undeclared.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0490_throws_suppress.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0490_throws_suppress.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0353_foreach_uncaught.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0353_foreach_uncaught.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0841_assign_op_creates_variable.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0841_assign_op_creates_variable.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0135_array_assignment_type.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0135_array_assignment_type.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0203_generic_errors.php.expected#L8) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0203_generic_errors.php#L27).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0203_generic_errors.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0203_generic_errors.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0597_template_support.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0597_template_support.php#L66).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0577_unknown_tags.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0577_unknown_tags.php#L20).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0203_generic_errors.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0203_generic_errors.php#L16).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0203_generic_errors.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0203_generic_errors.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0618_internal_in_root_ns.php#L38).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0278_internal_elements.php.expected#L24) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0278_internal_elements.php#L108).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0278_internal_elements.php.expected#L16) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0278_internal_elements.php#L94).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0618_internal_in_root_ns.php#L39).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0618_internal_in_root_ns.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0618_internal_in_root_ns.php#L37).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0524_closure_ambiguous.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0524_closure_ambiguous.php#L18).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0281_magic_method_support.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0281_magic_method_support.php#L17).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0612_comment_duplicated_property.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0612_comment_duplicated_property.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0611_comment_duplicated_param.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0611_comment_duplicated_param.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0332_override_complex.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0332_override_complex.php#L10).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0355_namespace_relative.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0355_namespace_relative.php#L34).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/086_comment_param_assertions.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/086_comment_param_assertions.php#L14).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/086_comment_param_assertions.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/086_comment_param_assertions.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0520_spaces_in_union_type.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0520_spaces_in_union_type.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0373_reject_bad_type_narrowing.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0373_reject_bad_type_narrowing.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0772_real_float_types.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0772_real_float_types.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0432_phan_comment.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0432_phan_comment.php#L5).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0301_comment_checks.php.expected#L4) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0301_comment_checks.php#L7).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/043_throws.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/043_throws.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/085_throw_type_mismatch.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/085_throw_type_mismatch.php#L17).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0828_crash_return_backslashes.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0828_crash_return_backslashes.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0284_non_empty_array_default.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0284_non_empty_array_default.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0627_signature_mismatch.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0627_signature_mismatch.php#L22).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0670_unparseable_property.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0670_unparseable_property.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0601_continue_scope_warning.php.expected#L5) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0601_continue_scope_warning.php#L24).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0601_continue_scope_warning.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0601_continue_scope_warning.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0723_duplicate_use.php.expected#L3) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0723_duplicate_use.php#L8).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0723_duplicate_use.php.expected#L2) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0723_duplicate_use.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0723_duplicate_use.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0723_duplicate_use.php#L4).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/015_class_const_declaration9.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/015_class_const_declaration9.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/026_invalid_assign.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/026_invalid_assign.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/expected/056_trait_use.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/misc/fallback_test/src/056_trait_use.php#L11).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/157_polyfill_compilation_warning.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/157_polyfill_compilation_warning.php#L77).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0799_array_destructuring_failures.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0799_array_destructuring_failures.php#L3).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/expected/136_unexpected_bracket.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/plugin_test/src/136_unexpected_bracket.php#L2).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0242_void_71.php.expected#L6) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0242_void_71.php#L6).
...
e.g. [this issue](https://github.com/phan/phan/tree/2.7.0/tests/files/expected/0242_void_71.php.expected#L1) is emitted when analyzing [this PHP file](https://github.com/phan/phan/tree/2.7.0/tests/files/src/0242_void_71.php#L3).
