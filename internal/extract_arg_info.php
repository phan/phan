...
class OpcacheFuncInfoParser
{
    ...
    public static function main() : void
    {
        ...
        self::checkOpcacheAndReflectionAreConsistent($opcache_data, $reflection_data);
...
EOT;
     ...
     */
    private static function checkOpcacheAndReflectionAreConsistent(array $reflection_data, array $opcache_data) : void
    {
        foreach ($opcache_data as $function_name => $opcache_type) {
            ...
            if (!$opcache_type->canCastToUnionType($reflection_type)) {
