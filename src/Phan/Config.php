...
class Config
{
    ...
    const DEFAULT_CONFIGURATION = [
        ...
        // A custom class resolver can be defined instead of the default Composer resolver. This class must be a
        // loaded fully qualified class name and conform to Phan\ClassResolver\ClassResolverInterface
        'class_resolver' => null,
