    ...
    private static function initializeTypeCastingMatrix(): array
    {
        ...
        $generate_row = static function (string ...$permitted_cast_type_names): array {
            return [
                ...
                NonFalsyStringType::NAME => in_array(NonFalsyStringType::NAME, $permitted_cast_type_names, true),
        ...
        return [
            ...
            CallableStringType::NAME => $generate_row(CallableStringType::NAME, CallableType::NAME, StringType::NAME, NonEmptyStringType::NAME, NonFalsyStringType::NAME),
            ClassStringType::NAME => $generate_row(ClassStringType::NAME, StringType::NAME, NonEmptyStringType::NAME, NonFalsyStringType::NAME),
            ...
            StringType::NAME   => $generate_row(StringType::NAME, CallableType::NAME, ScalarRawType::NAME, CallableStringType::NAME, ClassStringType::NAME, NonEmptyStringType::NAME, NonFalsyStringType::NAME),
            NonEmptyStringType::NAME   => $generate_row(NonEmptyStringType::NAME, NonFalsyStringType::NAME, StringType::NAME, CallableType::NAME, ScalarRawType::NAME, CallableStringType::NAME, ClassStringType::NAME),
            NonFalsyStringType::NAME   => $generate_row(NonFalsyStringType::NAME, NonEmptyStringType::NAME, StringType::NAME, CallableType::NAME, ScalarRawType::NAME, CallableStringType::NAME, ClassStringType::NAME),
