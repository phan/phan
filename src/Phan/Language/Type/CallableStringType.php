...
final class CallableStringType extends StringType implements CallableInterface
{
    ...
    {
        return $type instanceof CallableType || \in_array(\get_class($type), [StringType::class, NonEmptyStringType::class, NonFalsyStringType::class], true) || $type instanceof MixedType;
    }
}
