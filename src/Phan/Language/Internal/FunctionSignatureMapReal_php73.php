...
'array_keys' => '?array<int,int>|?array<int,string>',
'array_map' => '?array',
'array_merge' => '?array',
...
'debug_backtrace' => '?array<int,array>',
...
'dns_get_mx' => '?bool',
'dns_get_record' => '?array<int,array>|?false',
'doubleval' => '?float',
'each' => '?array|?false',
'error_log' => '?bool',
'error_reporting' => '?int',
...
'exp' => '?float',
'explode' => '?array<int,string>|?false',
'expm1' => '?float',
'extract' => '?int',
'ezmlm_hash' => '?int',
'fclose' => 'bool',
...
'fflush' => 'bool',
'fgetc' => 'false|string',
'fgetcsv' => '?array<int,?string>|?false',
'fgets' => 'false|string',
'fgetss' => 'false|string',
'file' => '?array<int,string>|?false',
'file_exists' => '?bool',
...
'fputs' => 'false|int',
'fread' => 'false|string',
'fscanf' => '?array<int,mixed>|?false|?int',
'fseek' => 'false|int',
...
'ftok' => '?int',
'ftruncate' => 'bool',
'func_get_args' => 'array<int,mixed>|false',
'func_num_args' => 'int',
'fwrite' => 'false|int',
'gc_disable' => 'void',
'gc_enable' => 'void',
...
'get_class_methods' => '?array<int,string>|?false',
...
'get_extension_funcs' => '?array<int,string>|?false',
'get_headers' => '?array<int,array>|?array<int,string>|?false',
'get_html_translation_table' => '?array<string,string>',
'get_loaded_extensions' => '?array<int,string>',
...
'gethostbynamel' => '?array<int,string>|?false',
...
'mb_detect_order' => '?array<int,string>|?false',
'mb_encode_mimeheader' => '?false|?string',
'mb_encode_numericentity' => '?false|?string',
'mb_encoding_aliases' => 'array<int,string>|false',
'mb_ereg' => 'false|int',
'mb_ereg_match' => 'bool',
...
'mb_send_mail' => '?bool',
'mb_split' => 'array<int,string>|false',
...
'ob_list_handlers' => '?array<int,string>',
'ob_start' => '?bool',
...
'preg_split' => '?array<int,array>|?array<int,string>|?false',
...
'rsort' => 'bool',
'rtrim' => '?string',
'scandir' => '?array<int,string>|?false',
...
'str_rot13' => '?string',
'str_shuffle' => '?string',
'str_split' => '?array<int,string>|?false',
...
'stream_get_transports' => 'array<int,string>|false',
'stream_get_wrappers' => 'array<int,string>|false',
...
'stream_socket_pair' => 'array<int,resource>|false',
...
'symlink' => '?bool',
'sys_getloadavg' => 'array<int,float>|false',
'syslog' => '?bool',
'system' => 'false|string',
'tan' => '?float',
'tanh' => '?float',
...
'timezone_identifiers_list' => 'array<int,string>|false',
