...
'each' => '?array|?false',
'ereg' => '?false|?int',
'ereg_replace' => '?false|?string',
'eregi' => '?false|?int',
'eregi_replace' => '?false|?string',
'error_log' => '?bool',
'error_reporting' => '?int',
...
'get_parrent_class' => 'false|string',
...
'mbereg_search_getregs' => 'array|false',
'mbereg_search_init' => '?bool',
'mbereg_search_pos' => '?array|?false',
'mbereg_search_regs' => '?array|?false',
...
'mt_rand' => '?false|?int',
'mt_srand' => 'void',
'mysql' => '?false|?resource',
'mysql_affected_rows' => '?false|?int',
'mysql_client_encoding' => '?false|?string',
'mysql_close' => '?bool',
'mysql_connect' => '?false|?resource',
'mysql_create_db' => '?bool',
'mysql_createdb' => '?bool',
'mysql_data_seek' => '?bool',
'mysql_db_name' => '?false|?string',
'mysql_db_query' => '?bool|?resource',
'mysql_dbname' => '?false|?string',
'mysql_drop_db' => '?bool',
'mysql_dropdb' => '?bool',
'mysql_errno' => '?false|?int',
'mysql_error' => '?false|?string',
'mysql_escape_string' => '?string',
'mysql_fetch_array' => '?array|?false',
'mysql_fetch_assoc' => '?array|?false',
'mysql_fetch_field' => '?false|?object',
'mysql_fetch_lengths' => '?array|?false',
'mysql_fetch_object' => '?false|?object',
'mysql_fetch_row' => '?array|?false',
'mysql_field_flags' => '?false|?string',
'mysql_field_len' => '?false|?int',
'mysql_field_name' => '?false|?string',
'mysql_field_seek' => '?bool',
'mysql_field_table' => '?false|?string',
'mysql_field_type' => '?false|?string',
'mysql_fieldflags' => '?false|?string',
'mysql_fieldlen' => '?false|?int',
'mysql_fieldname' => '?false|?string',
'mysql_fieldtable' => '?false|?string',
'mysql_fieldtype' => '?false|?string',
'mysql_free_result' => '?bool',
'mysql_freeresult' => '?bool',
'mysql_get_client_info' => '?string',
'mysql_get_host_info' => '?false|?string',
'mysql_get_proto_info' => '?false|?int',
'mysql_get_server_info' => '?false|?string',
'mysql_info' => '?false|?string',
'mysql_insert_id' => '?false|?int',
'mysql_list_dbs' => '?false|?resource',
'mysql_list_fields' => '?false|?resource',
'mysql_list_processes' => '?false|?resource',
'mysql_list_tables' => '?false|?resource',
'mysql_listdbs' => '?false|?resource',
'mysql_listfields' => '?false|?resource',
'mysql_listtables' => '?false|?resource',
'mysql_num_fields' => '?false|?int',
'mysql_num_rows' => '?false|?int',
'mysql_numfields' => '?false|?int',
'mysql_numrows' => '?false|?int',
'mysql_pconnect' => '?false|?resource',
'mysql_ping' => '?bool',
'mysql_query' => '?bool|?resource',
'mysql_real_escape_string' => '?false|?string',
'mysql_result' => '?false|?string',
'mysql_select_db' => '?bool',
'mysql_selectdb' => '?bool',
'mysql_set_charset' => '?bool',
'mysql_stat' => '?false|?string',
'mysql_table_name' => '?false|?string',
'mysql_tablename' => '?false|?string',
'mysql_thread_id' => '?false|?int',
'mysql_unbuffered_query' => '?bool|?resource',
