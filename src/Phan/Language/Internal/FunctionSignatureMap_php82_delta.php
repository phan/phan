...
return [
  ...
  'changed' => [
    ...
    'dba_fetch' => [
      'old' => ['string|false', 'key'=>'string', 'skip'=>'int', 'dba'=>'resource'],
    ...
    'iterator_apply' => [
      ...
      'new' => ['int', 'iterator'=>'Traversable|iterable', 'callback'=>'callable(mixed):bool', 'args='=>'array'],
    ],
    'iterator_count' => [
      'old' => ['int', 'iterator'=>'Traversable'],
      'new' => ['int', 'iterator'=>'Traversable|iterable'],
    ],
    'iterator_to_array' => [
      'old' => ['array', 'iterator'=>'Traversable', 'preserve_keys='=>'bool'],
      'new' => ['array', 'iterator'=>'Traversable|iterable', 'preserve_keys='=>'bool'],
    ],
    'IteratorIterator::__construct' => [
      'old' => ['void', 'iterator'=>'Traversable'],
      'new' => ['void', 'iterator'=>'Traversable|iterable'],
    ],
  ],
  'removed' => [
  ],
