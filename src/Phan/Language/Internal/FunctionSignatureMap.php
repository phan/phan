...
'MongoDB\Driver\Server::executeCommand' => ['\MongoDB\Driver\Cursor', 'db'=>'string', 'command'=>'Command'],
...
'SQLiteDatabase::unbufferedQuery' => ['SQLiteUnbuffered', 'query'=>'string', 'result_type='=>'int', 'error_msg='=>'string'],
...
'SQLiteUnbuffered::column' => ['', 'index_or_name'=>'', 'decode_binary='=>'bool'],
