...
'apc_fetch' => ['mixed', 'key'=>'', '&w_success='=>'bool'],
...
'apcu_fetch' => ['mixed', 'key'=>'', '&w_success='=>'bool'],
...
'ArrayIterator::append' => ['void', 'value'=>''],
...
'ArrayIterator::offsetSet' => ['void', 'index'=>'string', 'newval'=>''],
...
'ArrayObject::offsetGet' => ['mixed', 'index'=>''],
'ArrayObject::offsetSet' => ['void', 'index'=>'', 'newval'=>''],
'ArrayObject::offsetUnset' => ['void', 'index'=>''],
...
'array_reduce' => ['mixed', 'input'=>'array', 'callback'=>'callable', 'initial='=>''],
...
'assert_options' => ['mixed', 'what'=>'int', 'value='=>''],
...
'CachingIterator::offsetSet' => ['void', 'index'=>'', 'newval'=>''],
'CachingIterator::offsetUnset' => ['void', 'index'=>''],
...
'cairo_surface_write_to_png' => ['void', 'surface'=>'cairosurface', 'stream'=>''],
...
'call_user_func' => ['mixed', 'function'=>'callable', '...parameters='=>''],
'call_user_method_array' => ['mixed', 'method_name'=>'string', 'obj'=>'object', 'params'=>'array'],
'call_user_method' => ['mixed', 'method_name'=>'string', 'obj'=>'object', 'parameter='=>'', '...='=>''],
...
'cubrid_fetch' => ['mixed', 'result'=>'', 'type='=>'int'],
...
'cubrid_get' => ['mixed', 'conn_identifier'=>'', 'oid'=>'string', 'attr='=>''],
...
'curl_escape' => ['string', 'ch'=>'', 'str'=>'string'],
...
'cyrus_authenticate' => ['void', 'connection'=>'', 'mechlist='=>'string', 'service='=>'string', 'user='=>'string', 'minssf='=>'int', 'maxssf='=>'int', 'authname='=>'string', 'password='=>'string'],
...
'date_sunrise' => ['mixed', 'time'=>'', 'format='=>'int', 'latitude='=>'float', 'longitude='=>'float', 'zenith='=>'float', 'gmt_offset='=>'float'],
'date_sunset' => ['mixed', 'time'=>'', 'format='=>'int', 'latitude='=>'float', 'longitude='=>'float', 'zenith='=>'float', 'gmt_offset='=>'float'],
...
'db2_autocommit' => ['mixed', 'connection'=>'', 'value='=>'bool'],
...
'dbplus_rcrtexact' => ['mixed', 'name'=>'string', 'relation'=>'', 'overwrite='=>'bool'],
'dbplus_rcrtlike' => ['mixed', 'name'=>'string', 'relation'=>'', 'overwrite='=>'int'],
'dbplus_resolve' => ['array', 'relation_name'=>'string'],
'dbplus_restorepos' => ['int', 'relation'=>'', 'tuple'=>'array'],
'dbplus_rkeys' => ['mixed', 'relation'=>'', 'domlist'=>''],
...
'dbplus_rsecindex' => ['mixed', 'relation'=>'', 'domlist'=>'', 'type'=>'int'],
...
'dio_close' => ['void', 'fd'=>''],
'dio_fcntl' => ['mixed', 'fd'=>'', 'cmd'=>'int', 'args='=>''],
...
'DOMXPath::registerPhpFunctions' => ['void', 'restrict='=>''],
...
'enchant_dict_add_to_personal' => ['void', 'dict'=>'', 'word'=>'string'],
'enchant_dict_add_to_session' => ['void', 'dict'=>'', 'word'=>'string'],
...
'enchant_dict_store_replacement' => ['void', 'dict'=>'', 'mis'=>'string', 'cor'=>'string'],
...
'event_base_free' => ['void', 'event_base'=>''],
'EventBase::free' => ['void'],
...
'event_buffer_fd_set' => ['void', 'bevent'=>'', 'fd'=>''],
'event_buffer_free' => ['void', 'bevent'=>''],
...
'event_buffer_timeout_set' => ['void', 'bevent'=>'', 'read_timeout'=>'int', 'write_timeout'=>'int'],
'EventBuffer::unfreeze' => ['bool', 'at_front'=>'bool'],
'EventBuffer::unlock' => ['bool'],
'event_buffer_watermark_set' => ['void', 'bevent'=>'', 'events'=>'int', 'lowmark'=>'int', 'highmark'=>'int'],
...
'fbsql_result' => ['mixed', 'result'=>'', 'row='=>'int', 'field='=>''],
...
'fdf_get_opt' => ['mixed', 'fdf_document'=>'', 'fieldname'=>'string', 'element='=>'int'],
'fdf_get_status' => ['string', 'fdf_document'=>''],
'fdf_get_value' => ['mixed', 'fdf_document'=>'', 'fieldname'=>'string', 'which='=>'int'],
...
'filter_list' => ['array'],
'filter_var_array' => ['mixed', 'data'=>'array', 'definition='=>'', 'add_empty='=>'bool'],
'filter_var' => ['mixed', 'variable'=>'', 'filter='=>'int', 'options='=>''],
...
'forward_static_call' => ['mixed', 'function'=>'callable', '...parameters='=>''],
...
'get_parent_class' => ['string', 'object='=>''],
...
'gnupg_seterrormode' => ['void', 'identifier'=>'', 'errormode'=>'int'],
...
'gupnp_context_set_subscription_timeout' => ['void', 'context'=>'', 'timeout'=>'int'],
...
'gupnp_service_action_get' => ['mixed', 'action'=>'', 'name'=>'string', 'type'=>'int'],
...
'gupnp_service_info_get_introspection' => ['mixed', 'proxy'=>'', 'callback='=>'', 'arg='=>''],
...
'gupnp_service_proxy_action_get' => ['mixed', 'proxy'=>'', 'action'=>'string', 'name'=>'string', 'type'=>'int'],
...
'ibase_backup' => ['mixed', 'service_handle'=>'', 'source_db'=>'string', 'dest_file'=>'string', 'options='=>'int', 'verbose='=>'bool'],
...
'ibase_errcode' => ['int'],
'ibase_errmsg' => ['string'],
'ibase_execute' => ['resource', 'query'=>'', 'bind_arg='=>'', '...='=>''],
...
'ibase_query' => ['resource', 'link_identifier='=>'', 'string='=>'string', 'bind_arg='=>'', '...='=>''],
'ibase_restore' => ['mixed', 'service_handle'=>'', 'source_file'=>'string', 'dest_db'=>'string', 'options='=>'int', 'verbose='=>'bool'],
...
'imagecolorset' => ['void', 'im'=>'', 'col'=>'int', 'red'=>'int', 'green'=>'int', 'blue'=>'int', 'alpha='=>'int'],
...
'ingres_prepare' => ['mixed', 'link'=>'', 'query'=>'string'],
'ingres_query' => ['mixed', 'link'=>'', 'query'=>'string', 'params='=>'array', 'types='=>'string'],
'ingres_result_seek' => ['bool', 'result'=>'', 'position'=>'int'],
'ingres_rollback' => ['bool', 'link'=>''],
'ingres_set_environment' => ['bool', 'link'=>'', 'options'=>'array'],
'ingres_unbuffered_query' => ['mixed', 'link'=>'', 'query'=>'string', 'params='=>'array', 'types='=>'string'],
...
'libxml_set_streams_context' => ['void', 'streams_context'=>''],
...
'mailparse_msg_extract_part' => ['void', 'mimemail'=>'', 'msgbody'=>'string', 'callbackfunc='=>'callable'],
...
'mqseries_back' => ['void', 'hconn'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_begin' => ['void', 'hconn'=>'', 'beginoptions'=>'array', 'compcode'=>'', 'reason'=>''],
'mqseries_close' => ['void', 'hconn'=>'', 'hobj'=>'', 'options'=>'int', 'compcode'=>'', 'reason'=>''],
'mqseries_cmit' => ['void', 'hconn'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_conn' => ['void', 'qmanagername'=>'string', 'hconn'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_connx' => ['void', 'qmanagername'=>'string', 'connoptions'=>'array', 'hconn'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_disc' => ['void', 'hconn'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_get' => ['void', 'hconn'=>'', 'hobj'=>'', 'md'=>'array', 'gmo'=>'array', 'bufferlength'=>'int', 'msg'=>'string', 'data_length'=>'int', 'compcode'=>'', 'reason'=>''],
'mqseries_inq' => ['void', 'hconn'=>'', 'hobj'=>'', 'selectorcount'=>'int', 'selectors'=>'array', 'intattrcount'=>'int', 'intattr'=>'', 'charattrlength'=>'int', 'charattr'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_open' => ['void', 'hconn'=>'', 'objdesc'=>'array', 'option'=>'int', 'hobj'=>'', 'compcode'=>'', 'reason'=>''],
'mqseries_put1' => ['void', 'hconn'=>'', 'objdesc'=>'', 'msgdesc'=>'', 'pmo'=>'', 'buffer'=>'string', 'compcode'=>'', 'reason'=>''],
'mqseries_put' => ['void', 'hconn'=>'', 'hobj'=>'', 'md'=>'array', 'pmo'=>'array', 'message'=>'string', 'compcode'=>'', 'reason'=>''],
'mqseries_set' => ['void', 'hconn'=>'', 'hobj'=>'', 'selectorcount'=>'int', 'selectors'=>'array', 'intattrcount'=>'int', 'intattrs'=>'array', 'charattrlength'=>'int', 'charattrs'=>'array', 'compcode'=>'', 'reason'=>''],
...
'mssql_execute' => ['mixed', 'stmt'=>'', 'skip_results='=>'bool'],
...
'mssql_query' => ['mixed', 'query'=>'string', 'link_identifier='=>'', 'batch_size='=>'int'],
...
'ncurses_getch' => ['int'],
'ncurses_getmaxyx' => ['void', 'window'=>'', 'y'=>'int', 'x'=>'int'],
'ncurses_getmouse' => ['bool', 'mevent'=>'array'],
'ncurses_getyx' => ['void', 'window'=>'', 'y'=>'int', 'x'=>'int'],
...
'newt_checkbox_set_flags' => ['void', 'checkbox'=>'', 'flags'=>'int', 'sense'=>'int'],
'newt_checkbox_set_value' => ['void', 'checkbox'=>'', 'value'=>'string'],
'newt_checkbox_tree_add_item' => ['void', 'checkboxtree'=>'', 'text'=>'string', 'data'=>'', 'flags'=>'int', 'index'=>'int', '...='=>'int'],
'newt_checkbox_tree_find_item' => ['array', 'checkboxtree'=>'', 'data'=>''],
'newt_checkbox_tree_get_current' => ['mixed', 'checkboxtree'=>''],
...
'newt_checkbox_tree_set_current' => ['void', 'checkboxtree'=>'', 'data'=>''],
'newt_checkbox_tree_set_entry' => ['void', 'checkboxtree'=>'', 'data'=>'', 'text'=>'string'],
'newt_checkbox_tree_set_entry_value' => ['void', 'checkboxtree'=>'', 'data'=>'', 'value'=>'string'],
'newt_checkbox_tree_set_width' => ['void', 'checkbox_tree'=>'', 'width'=>'int'],
'newt_clear_key_buffer' => ['void'],
'newt_cls' => ['void'],
'newt_compact_button' => ['resource', 'left'=>'int', 'top'=>'int', 'text'=>'string'],
'newt_component_add_callback' => ['void', 'component'=>'', 'func_name'=>'', 'data'=>''],
'newt_component_takes_focus' => ['void', 'component'=>'', 'takes_focus'=>'bool'],
'newt_create_grid' => ['resource', 'cols'=>'int', 'rows'=>'int'],
'newt_cursor_off' => ['void'],
'newt_cursor_on' => ['void'],
'newt_delay' => ['void', 'microseconds'=>'int'],
'newt_draw_form' => ['void', 'form'=>''],
...
'newt_entry_set' => ['void', 'entry'=>'', 'value'=>'string', 'cursor_at_end='=>'bool'],
'newt_entry_set_filter' => ['void', 'entry'=>'', 'filter'=>'callable', 'data'=>''],
'newt_entry_set_flags' => ['void', 'entry'=>'', 'flags'=>'int', 'sense'=>'int'],
'newt_finished' => ['int'],
'newt_form_add_component' => ['void', 'form'=>'', 'component'=>''],
'newt_form_add_components' => ['void', 'form'=>'', 'components'=>'array'],
'newt_form_add_hot_key' => ['void', 'form'=>'', 'key'=>'int'],
'newt_form_destroy' => ['void', 'form'=>''],
'newt_form_get_current' => ['resource', 'form'=>''],
'newt_form' => ['resource', 'vert_bar='=>'', 'help='=>'string', 'flags='=>'int'],
'newt_form_run' => ['void', 'form'=>'', 'exit_struct'=>'array'],
'newt_form_set_background' => ['void', 'from'=>'', 'background'=>'int'],
'newt_form_set_height' => ['void', 'form'=>'', 'height'=>'int'],
'newt_form_set_size' => ['void', 'form'=>''],
'newt_form_set_timer' => ['void', 'form'=>'', 'milliseconds'=>'int'],
'newt_form_set_width' => ['void', 'form'=>'', 'width'=>'int'],
'newt_form_watch_fd' => ['void', 'form'=>'', 'stream'=>'', 'flags='=>'int'],
'newt_get_screen_size' => ['void', 'cols'=>'int', 'rows'=>'int'],
'newt_grid_add_components_to_form' => ['void', 'grid'=>'', 'form'=>'', 'recurse'=>'bool'],
'newt_grid_basic_window' => ['resource', 'text'=>'', 'middle'=>'', 'buttons'=>''],
'newt_grid_free' => ['void', 'grid'=>'', 'recurse'=>'bool'],
...
'newt_grid_place' => ['void', 'grid'=>'', 'left'=>'int', 'top'=>'int'],
'newt_grid_set_field' => ['void', 'grid'=>'', 'col'=>'int', 'row'=>'int', 'type'=>'int', 'val'=>'', 'pad_left'=>'int', 'pad_top'=>'int', 'pad_right'=>'int', 'pad_bottom'=>'int', 'anchor'=>'int', 'flags='=>'int'],
...
'newt_grid_wrapped_window_at' => ['void', 'grid'=>'', 'title'=>'string', 'left'=>'int', 'top'=>'int'],
'newt_grid_wrapped_window' => ['void', 'grid'=>'', 'title'=>'string'],
'newt_init' => ['int'],
'newt_label' => ['resource', 'left'=>'int', 'top'=>'int', 'text'=>'string'],
'newt_label_set_text' => ['void', 'label'=>'', 'text'=>'string'],
'newt_listbox_append_entry' => ['void', 'listbox'=>'', 'text'=>'string', 'data'=>''],
'newt_listbox_clear' => ['void', 'listobx'=>''],
'newt_listbox_clear_selection' => ['void', 'listbox'=>''],
'newt_listbox_delete_entry' => ['void', 'listbox'=>'', 'key'=>''],
'newt_listbox_get_current' => ['string', 'listbox'=>''],
'newt_listbox_get_selection' => ['array', 'listbox'=>''],
'newt_listbox_insert_entry' => ['void', 'listbox'=>'', 'text'=>'string', 'data'=>'', 'key'=>''],
'newt_listbox_item_count' => ['int', 'listbox'=>''],
'newt_listbox' => ['resource', 'left'=>'int', 'top'=>'int', 'height'=>'int', 'flags='=>'int'],
'newt_listbox_select_item' => ['void', 'listbox'=>'', 'key'=>'', 'sense'=>'int'],
'newt_listbox_set_current_by_key' => ['void', 'listbox'=>'', 'key'=>''],
'newt_listbox_set_current' => ['void', 'listbox'=>'', 'num'=>'int'],
'newt_listbox_set_data' => ['void', 'listbox'=>'', 'num'=>'int', 'data'=>''],
'newt_listbox_set_entry' => ['void', 'listbox'=>'', 'num'=>'int', 'text'=>'string'],
'newt_listbox_set_width' => ['void', 'listbox'=>'', 'width'=>'int'],
'newt_listitem_get_data' => ['mixed', 'item'=>''],
'newt_listitem' => ['resource', 'left'=>'int', 'top'=>'int', 'text'=>'string', 'is_default'=>'bool', 'prev_item'=>'resource', 'data'=>'', 'flags='=>'int'],
'newt_listitem_set' => ['void', 'item'=>'', 'text'=>'string'],
...
'newt_scale_set' => ['void', 'scale'=>'', 'amount'=>'int'],
'newt_scrollbar_set' => ['void', 'scrollbar'=>'', 'where'=>'int', 'total'=>'int'],
'newt_set_help_callback' => ['void', 'function'=>''],
'newt_set_suspend_callback' => ['void', 'function'=>'callable', 'data'=>''],
'newt_suspend' => ['void'],
...
'newt_textbox_set_height' => ['void', 'textbox'=>'', 'height'=>'int'],
'newt_textbox_set_text' => ['void', 'textbox'=>'', 'text'=>'string'],
...
'newt_win_message' => ['void', 'title'=>'string', 'button_text'=>'string', 'format'=>'string', 'args='=>'', '...='=>''],
...
'OAuthProvider::is2LeggedEndpoint' => ['void', 'params_array'=>''],
...
'odbc_result' => ['mixed', 'result_id'=>'', 'field'=>''],
...
'openal_source_get' => ['mixed', 'source'=>'', 'property'=>'int'],
...
'pg_delete' => ['mixed', 'db'=>'', 'table'=>'string', 'ids'=>'array', 'options='=>'int'],
...
'pg_field_table' => ['mixed', 'result'=>'', 'field_number'=>'int', 'oid_only='=>'bool'],
...
'pg_insert' => ['mixed', 'db'=>'', 'table'=>'string', 'values'=>'array', 'options='=>'int'],
...
'pg_result_status' => ['mixed', 'result'=>'', 'result_type='=>'int'],
'pg_select' => ['mixed', 'db'=>'', 'table'=>'string', 'ids'=>'array', 'options='=>'int', 'result_type='=>'int'],
...
'pg_update' => ['mixed', 'db'=>'', 'table'=>'string', 'fields'=>'array', 'ids'=>'array', 'options='=>'int'],
...
'preg_filter' => ['mixed', 'regex'=>'', 'replace'=>'', 'subject'=>'', 'limit='=>'int', '&w_count='=>'int'],
...
'ps_clip' => ['bool', 'psdoc'=>''],
'ps_close' => ['bool', 'psdoc'=>''],
'ps_close_image' => ['void', 'psdoc'=>'', 'imageid'=>'int'],
...
'px_set_tablename' => ['void', 'pxdoc'=>'', 'name'=>'string'],
...
'radius_get_attr' => ['mixed', 'radius_handle'=>''],
...
'RecursiveIteratorIterator::setMaxDepth' => ['void', 'max_depth='=>''],
...
'ReflectionClass::getStaticPropertyValue' => ['mixed', 'name'=>'string', 'default='=>''],
...
'ReflectionMethod::invokeArgs' => ['mixed', 'object'=>'', 'args'=>'array'],
'ReflectionMethod::invoke' => ['mixed', 'object'=>'', '...args='=>''],
...
'register_shutdown_function' => ['void', 'function'=>'callable', '...parameter='=>''],
...
'runkit_sandbox_output_handler' => ['mixed', 'sandbox'=>'object', 'callback='=>''],
...
'SDO_List::insert' => ['void', 'value'=>'', 'index='=>'int'],
...
'SDO_Sequence::insert' => ['void', 'value'=>'', 'sequenceindex='=>'int', 'propertyidentifier='=>''],
...
'shm_get_var' => ['mixed', 'id'=>'', 'variable_key'=>'int'],
...
'snmp2_get' => ['string', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp2_getnext' => ['string', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp2_real_walk' => ['array', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp2_set' => ['bool', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'type'=>'', 'value'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp2_walk' => ['array', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp3_get' => ['string', 'host'=>'string', 'sec_name'=>'string', 'sec_level'=>'string', 'auth_protocol'=>'string', 'auth_passphrase'=>'string', 'priv_protocol'=>'string', 'priv_passphrase'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp3_getnext' => ['string', 'host'=>'string', 'sec_name'=>'string', 'sec_level'=>'string', 'auth_protocol'=>'string', 'auth_passphrase'=>'string', 'priv_protocol'=>'string', 'priv_passphrase'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmp3_real_walk' => ['array', 'host'=>'string', 'sec_name'=>'string', 'sec_level'=>'string', 'auth_protocol'=>'string', 'auth_passphrase'=>'string', 'priv_protocol'=>'string', 'priv_passphrase'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
...
'snmp3_walk' => ['array', 'host'=>'string', 'sec_name'=>'string', 'sec_level'=>'string', 'auth_protocol'=>'string', 'auth_passphrase'=>'string', 'priv_protocol'=>'string', 'priv_passphrase'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'SNMP::close' => ['bool'],
'SNMP::__construct' => ['void', 'version'=>'int', 'hostname'=>'string', 'community'=>'string', 'timeout'=>'int', 'retries'=>'int'],
'SNMP::getErrno' => ['int'],
'SNMP::getError' => ['int'],
'snmpget' => ['string', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'snmpgetnext' => ['string', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'SNMP::getnext' => ['mixed', 'object_id'=>''],
'SNMP::get' => ['mixed', 'object_id'=>'', 'preserve_keys'=>'bool'],
'snmp_get_quick_print' => ['bool'],
'snmp_get_valueretrieval' => ['int'],
'snmp_read_mib' => ['bool', 'filename'=>'string'],
'snmprealwalk' => ['array', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
...
'snmpwalk' => ['array', 'host'=>'string', 'community'=>'string', 'object_id'=>'', 'timeout='=>'int', 'retries='=>'int'],
'SNMP::walk' => ['array', 'object_id'=>'', 'suffix_as_key'=>'bool', 'max_repetitions'=>'int', 'non_repeaters'=>'int'],
...
'SoapServer::addFunction' => ['void', 'functions'=>''],
...
'SoapServer::setClass' => ['void', 'class_name'=>'string', '...='=>''],
...
'socket_clear_error' => ['void', 'socket='=>''],
...
'spl_classes' => ['array'],
'SplDoublyLinkedList::add' => ['void', 'index'=>'', 'newval'=>''],
...
'SplDoublyLinkedList::offsetSet' => ['void', 'index'=>'', 'newval'=>''],
'SplDoublyLinkedList::offsetUnset' => ['void', 'index'=>''],
...
'ssh2_auth_none' => ['mixed', 'session'=>'', 'username'=>'string'],
...
'str_ireplace' => ['mixed', 'search'=>'', 'replace'=>'', 'subject'=>'', '&w_replace_count='=>'int'],
...
'substr_replace' => ['mixed', 'str'=>'', 'repl'=>'', 'start'=>'', 'length='=>''],
...
'sybase_query' => ['mixed', 'query'=>'string', 'link_identifier='=>''],
...
'TokyoTyrantTable::add' => ['void', 'key'=>'string', 'increment'=>'', 'type='=>'string'],
'TokyoTyrantTable::genUid' => ['int'],
'TokyoTyrantTable::getIterator' => ['TokyoTyrantIterator'],
'TokyoTyrantTable::get' => ['array', 'keys'=>''],
'TokyoTyrantTable::getQuery' => ['TokyoTyrantQuery'],
'TokyoTyrantTable::out' => ['void', 'keys'=>''],
...
'TokyoTyrantTable::putNr' => ['void', 'keys'=>'', 'value='=>'string'],
...
'var_dump' => ['void', 'var'=>'', '...='=>''],
'var_export' => ['mixed', 'var'=>'', 'return='=>'bool'],
'variant_abs' => ['mixed', 'left'=>''],
'variant_add' => ['mixed', 'left'=>'', 'right'=>''],
'variant_and' => ['mixed', 'left'=>'', 'right'=>''],
'variant_cast' => ['object', 'variant'=>'object', 'type'=>'int'],
'variant_cat' => ['mixed', 'left'=>'', 'right'=>''],
...
'variant_div' => ['mixed', 'left'=>'', 'right'=>''],
'variant_eqv' => ['mixed', 'left'=>'', 'right'=>''],
'variant_fix' => ['mixed', 'left'=>''],
'variant_get_type' => ['int', 'variant'=>'object'],
'variant_idiv' => ['mixed', 'left'=>'', 'right'=>''],
'variant_imp' => ['mixed', 'left'=>'', 'right'=>''],
'variant_int' => ['mixed', 'left'=>''],
'variant_mod' => ['mixed', 'left'=>'', 'right'=>''],
'variant_mul' => ['mixed', 'left'=>'', 'right'=>''],
'variant_neg' => ['mixed', 'left'=>''],
'variant_not' => ['mixed', 'left'=>''],
'variant_or' => ['mixed', 'left'=>'', 'right'=>''],
'variant_pow' => ['mixed', 'left'=>'', 'right'=>''],
'variant_round' => ['mixed', 'left'=>'', 'decimals'=>'int'],
'variant_set_type' => ['void', 'variant'=>'object', 'type'=>'int'],
'variant_set' => ['void', 'variant'=>'object', 'value'=>''],
'variant_sub' => ['mixed', 'left'=>'', 'right'=>''],
'variant_xor' => ['mixed', 'left'=>'', 'right'=>''],
...
'wincache_ucache_get' => ['mixed', 'key'=>'', '&w_success='=>'bool'],
...
'xmlrpc_server_call_method' => ['string', 'server'=>'', 'xml'=>'string', 'user_data'=>'', 'output_options='=>'array'],
...
'XSLTProcessor::registerPHPFunctions' => ['void', 'restrict='=>''],
