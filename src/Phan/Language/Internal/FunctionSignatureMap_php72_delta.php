...
'new' => [
    ...
    'ldap_exop' => ['bool|resource', 'link'=>'resource', 'reqoid'=>'string', 'reqdata='=>'string', 'serverctrls='=>'array', '&w_retdata='=>'string', '&w_retoid='=>'string'],
    'ldap_exop_passwd' => ['bool|string', 'link'=>'resource', 'user='=>'string', 'oldpw='=>'string', 'newpw='=>'string', 'serverctrls='=>'array'],
    ...
    'mb_ord' => ['int|false', 'string'=>'string', 'enc='=>'string'],
    ...
    'sodium_crypto_scalarmult_base' => ['string', 'sk'=>'string'],
    ...
    'sodium_increment' => ['void', '&binary_string'=>'string'],
