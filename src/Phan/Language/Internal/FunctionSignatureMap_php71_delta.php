...
'new' => [
    ...
    'getopt' => ['array<string,string>|array<string,false>|array<string,array<int,string|false>>|false', 'options'=>'string', 'longopts='=>'array', '&w_optind='=>'int'],
...
'old' => [
    ...
    'getopt' => ['array<string,string>|array<string,false>|array<string,array<int,string|false>|false>', 'options'=>'string', 'longopts='=>'array'],
