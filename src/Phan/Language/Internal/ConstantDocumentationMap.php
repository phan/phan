...
'SQLSRV_TXN_READ_COMMITTED' => 'Inidicates a transaction isolation level of READ COMMITTED. This value is used to set the TransactionIsolation level in the $connectionOptions array passed to `sqlsrv_connect`.',
'SQLSRV_TXN_READ_SERIALIZABLE' => 'Inidicates a transaction isolation level of SERIALIZABLE. This value is used to set the TransactionIsolation level in the $connectionOptions array passed to `sqlsrv_connect`.',
'SQLSRV_TXN_READ_UNCOMMITTED' => 'Inidicates a transaction isolation level of READ UNCOMMITTED. This value is used to set the TransactionIsolation level in the $connectionOptions array passed to `sqlsrv_connect`.',
'SQLSRV_TXN_REPEATABLE_READ' => 'Inidicates a transaction isolation level of REPEATABLE READ. This value is used to set the TransactionIsolation level in the $connectionOptions array passed to `sqlsrv_connect`.',
'SQLSRV_TXN_SNAPSHOT' => 'Inidicates a transaction isolation level of SNAPSHOT. This value is used to set the TransactionIsolation level in the $connectionOptions array passed to `sqlsrv_connect`.',
