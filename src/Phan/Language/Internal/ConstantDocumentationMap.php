...
'ast\AST_PROPERTY_HOOK' => 'A property hook declaration (in PHP 8.4+). Used in AST version 110+ (children: name, docComment, params, stmts, attributes)',
'ast\AST_PROPERTY_HOOK_SHORT_BODY' => 'A property hook declaration (in PHP 8.4+). Used in AST version 110+ (children: expr)',
