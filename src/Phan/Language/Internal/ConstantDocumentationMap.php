...
'DB2_PASSTHRU' => 'Specifies that binary data shall be converted to a <code>null</code> value.',
...
'FANN_ERRORFUNC_TANH' => 'Tanh error function, usually better but can require a lower learning rate. This error function agressively targets outputs that differ much from the desired, while not targetting outputs that only differ a little that much. This activation function is not recommended for cascade training and incremental training.',
...
'FILEINFO_EXTENSION' => 'Returns the file extension appropiate for a the MIME type detected in the file.

For types that commonly have multiple file extensions, such as JPEG images, then the return value is multiple extensions speparated by a forward slash e.g.: "jpeg/jpg/jpe/jfif". For unknown types not available in the magic.mime database, then return value is "???".
...
'imagick::ALPHACHANNEL_ACTIVATE' => '<code>imagick.constant.available</code> 6.3.8 or higher.',
'imagick::ALPHACHANNEL_COPY' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::ALPHACHANNEL_DEACTIVATE' => '<code>imagick.constant.available</code> 6.3.8 or higher.',
'imagick::ALPHACHANNEL_EXTRACT' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::ALPHACHANNEL_OPAQUE' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::ALPHACHANNEL_RESET' => '<code>imagick.constant.available</code> 6.3.8 or higher.',
'imagick::ALPHACHANNEL_SET' => '<code>imagick.constant.available</code> 6.3.8 or higher.',
'imagick::ALPHACHANNEL_SHAPE' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::ALPHACHANNEL_TRANSPARENT' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::ALPHACHANNEL_UNDEFINED' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
...
'imagick::COLORSPACE_CMY' => '<code>imagick.constant.available</code> 6.4.2 or higher.',
...
'imagick::COMPRESSION_DXT1' => '<code>imagick.constant.available</code> 6.4.0 or higher.',
'imagick::COMPRESSION_DXT3' => '<code>imagick.constant.available</code> 6.4.0 or higher.',
'imagick::COMPRESSION_DXT5' => '<code>imagick.constant.available</code> 6.4.0 or higher.',
...
'imagick::DISTORTION_AFFINE' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_AFFINEPROJECTION' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_ARC' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_BARREL' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_BARRELINVERSE' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_BILINEAR' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_DEPOLAR' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_PERSPECTIVE' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_PERSPECTIVEPROJECTION' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_POLAR' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_POLYNOMIAL' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_SCALEROTATETRANSLATE' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DISTORTION_SENTINEL' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_SHEPARDS' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DISTORTION_UNDEFINED' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::DITHERMETHOD_FLOYDSTEINBERG' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DITHERMETHOD_NO' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DITHERMETHOD_RIEMERSMA' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::DITHERMETHOD_UNDEFINED' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::EVALUATE_ADDMODULUS' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_COSINE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_GAUSSIANNOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_IMPULSENOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_LAPLACIANNOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_LOG' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_MULTIPLICATIVENOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_POISSONNOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_POW' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_SINE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_THRESHOLD' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_THRESHOLDBLACK' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_THRESHOLDWHITE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::EVALUATE_UNIFORMNOISE' => '<code>imagick.constant.available</code> 6.4.4 or higher.',
'imagick::FUNCTION_POLYNOMIAL' => '<code>imagick.constant.available</code> 6.4.9 or higher.',
'imagick::FUNCTION_SINUSOID' => '<code>imagick.constant.available</code> 6.4.9 or higher.',
'imagick::FUNCTION_UNDEFINED' => '<code>imagick.constant.available</code> 6.4.9 or higher.',
'imagick::INTERLACE_GIF' => '<code>imagick.constant.available</code> 6.3.4 or higher.',
'imagick::INTERPOLATE_AVERAGE' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_BICUBIC' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_BILINEAR' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_FILTER' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_INTEGER' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_MESH' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_NEARESTNEIGHBOR' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::INTERPOLATE_SPLINE' => '<code>imagick.constant.available</code> 6.3.4 or higher.',
'imagick::INTERPOLATE_UNDEFINED' => '<code>imagick.constant.available</code> 6.3.2 or higher.',
'imagick::LAYERMETHOD_COALESCE' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_COMPAREANY' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_COMPARECLEAR' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_COMPAREOVERLAY' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_COMPOSITE' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::LAYERMETHOD_DISPOSE' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_FLATTEN' => '<code>imagick.constant.available</code> 6.3.7 or higher.',
'imagick::LAYERMETHOD_MERGE' => '<code>imagick.constant.available</code> 6.3.7 or higher.',
'imagick::LAYERMETHOD_MOSAIC' => '<code>imagick.constant.available</code> 6.3.7 or higher.',
'imagick::LAYERMETHOD_OPTIMIZE' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_OPTIMIZEIMAGE' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::LAYERMETHOD_OPTIMIZEPLUS' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::LAYERMETHOD_OPTIMIZETRANS' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::LAYERMETHOD_REMOVEDUPS' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::LAYERMETHOD_REMOVEZERO' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::LAYERMETHOD_UNDEFINED' => '<code>imagick.constant.available</code> 6.2.9 or higher.',
'imagick::NOISE_RANDOM' => '<code>imagick.constant.available</code> 6.3.6 or higher.',
'imagick::ORIENTATION_BOTTOMLEFT' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_BOTTOMRIGHT' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_LEFTBOTTOM' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_LEFTTOP' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_RIGHTBOTTOM' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_RIGHTTOP' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_TOPLEFT' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_TOPRIGHT' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
'imagick::ORIENTATION_UNDEFINED' => '<code>imagick.constant.available</code> 6.3.0 or higher.',
...
'imagick::RESOURCETYPE_THREAD' => 'Set maximum parallel threads. <code>imagick.constant.available</code> 6.7.8 or higher.',
'imagick::SPARSECOLORMETHOD_BARYCENTRIC' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::SPARSECOLORMETHOD_BILINEAR' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::SPARSECOLORMETHOD_POLYNOMIAL' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::SPARSECOLORMETHOD_SPEPARDS' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::SPARSECOLORMETHOD_UNDEFINED' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::SPARSECOLORMETHOD_VORONOI' => '<code>imagick.constant.available</code> 6.4.6 or higher.',
'imagick::VIRTUALPIXELMETHOD_BLACK' => '<code>imagick.constant.available</code> 6.4.2 or higher.',
'imagick::VIRTUALPIXELMETHOD_GRAY' => '<code>imagick.constant.available</code> 6.4.2 or higher.',
'imagick::VIRTUALPIXELMETHOD_HORIZONTALTILE' => '<code>imagick.constant.available</code> 6.4.3 or higher.',
'imagick::VIRTUALPIXELMETHOD_MASK' => '<code>imagick.constant.available</code> 6.4.2 or higher.',
'imagick::VIRTUALPIXELMETHOD_VERTICALTILE' => '<code>imagick.constant.available</code> 6.4.3 or higher.',
'imagick::VIRTUALPIXELMETHOD_WHITE' => '<code>imagick.constant.available</code> 6.4.2 or higher.',
...
'JSON_ERROR_RECURSION' => 'The object or array passed to json_encode include recursive references and cannot be encoded. If the JSON_PARTIAL_OUTPUT_ON_ERROR option was given, <code>null</code> will be encoded in the place of the recursive reference. Available since PHP 5.5.0.',
...
'JSON_ERROR_UNSUPPORTED_TYPE' => 'A value of an unsupported type was given to json_encode, such as a resource. If the JSON_PARTIAL_OUTPUT_ON_ERROR option was given, <code>null</code> will be encoded in the place of the unsupported value. Available since PHP 5.5.0.',
...
'JSON_OBJECT_AS_ARRAY' => 'Decodes JSON objects as PHP array. This option can be added automatically by calling json_decode with the second parameter equal to <code>true</code>. Available since PHP 5.4.0.',
...
'MONGO_SUPPORTS_SSL' => '1 when is enabled and available.',
...
'PDO::ATTR_AUTOCOMMIT' => 'If this value is <code>false</code>, PDO attempts to disable autocommit so that the connection begins a transaction.',
...
'PDO::MYSQL_ATTR_USE_BUFFERED_QUERY' => 'If this attribute is set to <code>true</code> on a PDOStatement, the MySQL driver will use the buffered versions of the MySQL API. If you\'re writing portable code, you should use PDOStatement::fetchAll instead.',
...
'PGSQL_CONV_IGNORE_NOT_NULL' => 'Passed to pg_convert. Ignore conversion of <code>null</code> into SQL NOT NULL columns.',
...
'SQLSRV_CURSOR_DYNAMIC' => 'Inidicates a dynamic cursor. For usage information, see Specifying a Cursor Type and Selecting Rows.',
'SQLSRV_CURSOR_FORWARD' => 'Inidicates a forward-only cursor. For usage information, see Specifying a Cursor Type and Selecting Rows.',
'SQLSRV_CURSOR_KEYSET' => 'Inidicates a keyset cursor. For usage information, see Specifying a Cursor Type and Selecting Rows.',
'SQLSRV_CURSOR_STATIC' => 'Inidicates a static cursor. For usage information, see Specifying a Cursor Type and Selecting Rows.',
...
'SQLSRV_TXN_READ_COMMITTED' => 'Inidicates a transaction isolation level of READ COMMITTED. This value is used to set the TransactionIsolation level in the $connectionOptions arrary passed to sqlsrv_connect.',
'SQLSRV_TXN_READ_SERIALIZABLE' => 'Inidicates a transaction isolation level of SERIALIZABLE. This value is used to set the TransactionIsolation level in the $connectionOptions arrary passed to sqlsrv_connect.',
'SQLSRV_TXN_READ_UNCOMMITTED' => 'Inidicates a transaction isolation level of READ UNCOMMITTED. This value is used to set the TransactionIsolation level in the $connectionOptions arrary passed to sqlsrv_connect.',
'SQLSRV_TXN_REPEATABLE_READ' => 'Inidicates a transaction isolation level of REPEATABLE READ. This value is used to set the TransactionIsolation level in the $connectionOptions arrary passed to sqlsrv_connect.',
'SQLSRV_TXN_SNAPSHOT' => 'Inidicates a transaction isolation level of SNAPSHOT. This value is used to set the TransactionIsolation level in the $connectionOptions arrary passed to sqlsrv_connect.',
...
'ZEND_EXIT' => 'Invoked by exit() and die(), receives no arguments. Return boolean <code>true</code> to exit, <code>false</code> to continue',
