...
class CLI
{
     ...
     */
    public const PHAN_VERSION = '6.0.0-beta';
    ...
    /**
     * @param list<string> $binaries - various binaries, such as 'php84' and '/usr/bin/php'
     * @throws UsageException
     */
...
EOT;
 ...
 -m, --output-mode <mode>
  Output mode from 'text', 'verbose', 'json', 'csv', 'codeclimate', 'checkstyle', 'pylint', 'html', or 'github'
