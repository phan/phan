...
trait ConditionVisitorUtil
{
     ...
     */
    public function warnRedundantOrImpossibleScalar(float|int|string $node): void
    {
     ...
     */
    protected function chooseIssueForUnconditionallyTrue(bool $is_negated, mixed $node): string
    {
