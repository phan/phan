...
class RedundantCondition
{
    private const LOOP_ISSUE_NAMES = [
        ...
        Issue::RedundantValueComparison     => Issue::RedundantValueComparisonInLoop,
        Issue::ImpossibleValueComparison    => Issue::ImpossibleValueComparisonInLoop,
    ...
    private const GLOBAL_ISSUE_NAMES = [
        ...
        Issue::RedundantValueComparison     => Issue::RedundantValueComparisonInGlobalScope,
        Issue::ImpossibleValueComparison    => Issue::ImpossibleValueComparisonInGlobalScope,
