    ...
    ReturnTypeOverrideCapability
{
    ...
    public static function getReturnTypeOverridesStatic(CodeBase $code_base): array
    {
        ...
        $json_decode_array_types = UnionType::fromFullyQualifiedPHPDocString('array|null');
        $json_decode_object_types = UnionType::fromFullyQualifiedPHPDocString('\stdClass|list<mixed>|null');
        $json_decode_array_or_object_types = UnionType::fromFullyQualifiedPHPDocString('\stdClass|array|null');
